...
_template:"<template tag-name=\"lyte-daterangepicker\"> <template is=\"switch\" value=\"{{ltPropSelectionType}}\"><template case=\"continuous\"> <div class=\"lyteDateRangePickerRow\" __mousedown=\"{{action('mouseDown',event)}}\" __mouseover=\"{{action('mouseOver',event)}}\" __keydown=\"{{action('keydown',event)}}\"> <div class=\"lyteDateRangePickerCol1\"> <lyte-calendar lt-prop-fill-rows-variants=\"{{startFill}}\" on-month-selected=\"{{method('monthSelect','1')}}\" lt-prop=\"{{ltPropCalendar}}\" lt-prop-header-type=\"{{ltPropHeaderType}}\" nav-yield=\"{{navYield1}}\" lt-prop-format=\"{{ltPropFormat}}\" lt-prop-max-date=\"{{ltPropMaxDate}}\" lt-prop-min-date=\"{{ltPropMinDate}}\" lt-prop-fill-rows=\"{{ltPropFillRows}}\" lt-prop-start-week-day=\"{{ltPropStartWeekDay}}\" class=\"dRPCalendar1\" on-viewdate-change=\"{{method('viewDateChange','cal1')}}\" lt-prop-disable-navigation=\"true\" header-id=\"{{lbind(headerId1)}}\" month-dropdown-id=\"{{lbind(monthDropdownId1)}}\" year-dropdown-id=\"{{lbind(yearDropdownId1)}}\" month-header=\"{{lbind(monthHeader1)}}\"> <template is=\"registerYield\" yield-name=\"navigator\"> <div class=\"lyteDateRPLeftNav\"> <template is=\"if\" value=\"{{ltPropYear}}\"><template case=\"true\"><span role=\"button\" case=\"true\" class=\"lyteCalNav lyteCalyearNavLft\" tabindex=\"{{navtab}}\" aria-label=\"{{previousYear}}\" __click=\"{{action('previous','Y',event)}}\" __keydown=\"{{action('prevKey','Y',event)}}\"> </span></template></template> <span role=\"button\" class=\"lyteCalNav lyteCaldLft\" tabindex=\"{{navtab}}\" aria-label=\"{{previousMonth}}\" __click=\"{{action('previous','M',event)}}\" __keydown=\"{{action('prevKey','M',event)}}\"> </span> </div> <div class=\"{{lyteUiDateRPHeaderClass(ltPropHeaderType)}}\"> <template is=\"switch\" value=\"{{ltPropHeaderType}}\"> <template case=\"dropdown\"> <lyte-dropdown on-before-show=\"{{method('addDropdownClass')}}\" on-show=\"{{method('editArrowPosition')}}\" lt-prop-callout=\"true\" class=\"monthDD\" lt-prop-tabindex=\"{{droptab1}}\" on-option-selected=\"{{method('optionSelected','cal1','M')}}\" lt-prop=\"{{ltPropDropdown}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateRangepickerDropdown\"> <lyte-drop-body> <template is=\"for\" items=\"{{monthNames}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <lyte-dropdown on-before-show=\"{{method('addDropdownClass')}}\" on-show=\"{{method('editArrowPosition')}}\" lt-prop-callout=\"true\" class=\"yearDD\" lt-prop-tabindex=\"{{droptab2}}\" on-option-selected=\"{{method('optionSelected','cal1','Y')}}\" lt-prop=\"{{ltPropDropdown}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateRangepickerDropdown\"> <lyte-drop-body> <template is=\"for\" items=\"{{years}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <span class=\"lyteVisuallyHidden\" aria-live=\"polite\" id=\"{{headerId1}}\">{{monthHeader1}}</span> </template> <template case=\"drilldown\"> <button aria-label=\"{{lyteUiI18n('lyte.calendar.monthview.drilldown.button')}}\" tabindex=\"0\" class=\"lyteDrillCalHeaderButton\" __click=\"{{action('switchDrill',event,this,'1')}}\"> <span class=\"lyteCalsCalMonth\">{{lyteUiGetMonthOrYear(monthHeader1,\"M\")}}</span> <span class=\"lyteCalsCalYear\">{{lyteUiGetMonthOrYear(monthHeader1,\"Y\")}}</span> </button> </template> <template default=\"\"> <span aria-live=\"polite\" id=\"{{headerId1}}\">{{monthHeader1}}</span>  </template> </template> </div> </template> </lyte-calendar> </div> <div class=\"lyteDateRangePickerCol2\"> <lyte-calendar lt-prop-fill-rows-variants=\"{{endFill}}\" on-month-selected=\"{{method('monthSelect','2')}}\" lt-prop=\"{{ltPropCalendar}}\" lt-prop-header-type=\"{{ltPropHeaderType}}\" nav-yield=\"{{navYield2}}\" lt-prop-format=\"{{ltPropFormat}}\" lt-prop-max-date=\"{{ltPropMaxDate}}\" lt-prop-min-date=\"{{ltPropMinDate}}\" lt-prop-fill-rows=\"{{ltPropFillRows}}\" lt-prop-start-week-day=\"{{ltPropStartWeekDay}}\" class=\"dRPCalendar2\" select-date=\"false\" on-viewdate-change=\"{{method('viewDateChange','cal2')}}\" lt-prop-disable-navigation=\"true\" header-id=\"{{lbind(headerId2)}}\" month-dropdown-id=\"{{lbind(monthDropdownId2)}}\" year-dropdown-id=\"{{lbind(yearDropdownId2)}}\" month-header=\"{{lbind(monthHeader2)}}\"> <template is=\"registerYield\" yield-name=\"navigator\"> <div class=\"{{lyteUiDateRPHeaderClass(ltPropHeaderType)}}\"> <template is=\"switch\" value=\"{{ltPropHeaderType}}\"> <template case=\"dropdown\"> <lyte-dropdown on-before-show=\"{{method('addDropdownClass')}}\" on-show=\"{{method('editArrowPosition')}}\" lt-prop-callout=\"true\" class=\"monthDD\" lt-prop-tabindex=\"{{droptab1}}\" on-option-selected=\"{{method('optionSelected','cal2','M')}}\" lt-prop=\"{{ltPropDropdown}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateRangepickerDropdown\"> <lyte-drop-body> <template is=\"for\" items=\"{{monthNames}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <lyte-dropdown on-before-show=\"{{method('addDropdownClass')}}\" on-show=\"{{method('editArrowPosition')}}\" lt-prop-callout=\"true\" class=\"yearDD\" lt-prop-tabindex=\"{{droptab2}}\" on-option-selected=\"{{method('optionSelected','cal2','Y')}}\" lt-prop=\"{{ltPropDropdown}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateRangepickerDropdown\"> <lyte-drop-body> <template is=\"for\" items=\"{{years}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <span class=\"lyteVisuallyHidden\" aria-live=\"polite\" id=\"{{headerId2}}\">{{monthHeader2}}</span> </template> <template case=\"drilldown\"> <button aria-label=\"{{lyteUiI18n('lyte.calendar.monthview.drilldown.button')}}\" tabindex=\"0\" class=\"lyteDrillCalHeaderButton\" __click=\"{{action('switchDrill',event,this,'2')}}\"> <span class=\"lyteCalsCalMonth\">{{lyteUiGetMonthOrYear(monthHeader2,\"M\")}}</span> <span class=\"lyteCalsCalYear\">{{lyteUiGetMonthOrYear(monthHeader2,\"Y\")}}</span> </button> </template> <template default=\"\"> <span aria-live=\"polite\" id=\"{{headerId2}}\">{{monthHeader2}}</span>  </template> </template> </div> <div class=\"lyteDateRPRightNav\"> <span role=\"button\" case=\"true\" class=\"lyteCalNav lyteCaldRgt\" tabindex=\"{{navtab}}\" aria-label=\"{{nextMonth}}\" __click=\"{{action('previous','M',event,'next')}}\" __keydown=\"{{action('nextKey','M',event)}}\"> </span> <template is=\"if\" value=\"{{ltPropYear}}\"><template case=\"true\"><span role=\"button\" class=\"lyteCalNav lyteCalyearNavRgt\" tabindex=\"{{navtab}}\" aria-label=\"{{nextYear}}\" __click=\"{{action('previous','Y',event,'next')}}\" __keydown=\"{{action('nextKey','Y',event)}}\"> </span></template></template> </div> </template> </lyte-calendar> </div> </div> </template><template case=\"separate\"> <div class=\"lyteDateRangePickerRow lyteSeperateDRP\" __mousedown=\"{{action('separateMouseDown',event)}}\" __keydown=\"{{action('keydown',event)}}\"> <div class=\"lyteDateRangePickerCol1\"> <lyte-calendar on-month-selected=\"{{method('monthSelect','1')}}\" lt-prop=\"{{ltPropCalendar}}\" lt-prop-header-type=\"{{ltPropHeaderType}}\" nav-yield=\"{{navYield1}}\" lt-prop-format=\"{{ltPropFormat}}\" lt-prop-max-date=\"{{ltPropMaxDate}}\" lt-prop-min-date=\"{{ltPropMinDate}}\" lt-prop-fill-rows=\"{{ltPropFillRows}}\" lt-prop-start-week-day=\"{{ltPropStartWeekDay}}\" class=\"dRPCalendar1\" on-viewdate-change=\"{{method('viewDateChange','cal1')}}\" lt-prop-disable-navigation=\"true\" header-id=\"{{lbind(headerId1)}}\" month-dropdown-id=\"{{lbind(monthDropdownId1)}}\" year-dropdown-id=\"{{lbind(yearDropdownId1)}}\" month-header=\"{{lbind(monthHeader1)}}\"> <template is=\"registerYield\" yield-name=\"navigator\"> <div class=\"lyteDateRPLeftNav\"> <template is=\"if\" value=\"{{ltPropYear}}\"><template case=\"true\"><span role=\"button\" case=\"true\" class=\"lyteCalNav lyteCalyearNavLft\" tabindex=\"{{navtab}}\" aria-label=\"{{previousYear}}\" __click=\"{{action('separatePrevious','Y','cal1',event)}}\" __keydown=\"{{action('prevKey','Y',event,'cal1')}}\"> </span></template></template> <span role=\"button\" class=\"lyteCalNav lyteCaldLft\" tabindex=\"{{navtab}}\" aria-label=\"{{previousMonth}}\" __click=\"{{action('separatePrevious','M','cal1',event)}}\" __keydown=\"{{action('prevKey','M',event,'cal1')}}\"> </span> </div> <div class=\"{{lyteUiDateRPHeaderClass(ltPropHeaderType)}}\"> <template is=\"switch\" value=\"{{ltPropHeaderType}}\"> <template case=\"dropdown\"> <lyte-dropdown on-before-show=\"{{method('addDropdownClass')}}\" on-show=\"{{method('editArrowPosition')}}\" lt-prop-callout=\"true\" class=\"monthDD\" lt-prop-tabindex=\"{{droptab1}}\" on-option-selected=\"{{method('optionSelected','cal1','M')}}\" lt-prop=\"{{ltPropDropdown}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateRangepickerDropdown\"> <lyte-drop-body> <template is=\"for\" items=\"{{monthNames}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <lyte-dropdown on-before-show=\"{{method('addDropdownClass')}}\" on-show=\"{{method('editArrowPosition')}}\" lt-prop-callout=\"true\" class=\"yearDD\" lt-prop-tabindex=\"{{droptab2}}\" on-option-selected=\"{{method('optionSelected','cal1','Y')}}\" lt-prop=\"{{ltPropDropdown}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateRangepickerDropdown\"> <lyte-drop-body> <template is=\"for\" items=\"{{years}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <span class=\"lyteVisuallyHidden\" aria-live=\"polite\" id=\"{{headerId1}}\">{{monthHeader1}}</span> </template> <template case=\"drilldown\"> <button aria-label=\"{{lyteUiI18n('lyte.calendar.monthview.drilldown.button')}}\" tabindex=\"0\" class=\"lyteDrillCalHeaderButton\" __click=\"{{action('switchDrill',event,this,'1')}}\"> <span class=\"lyteCalsCalMonth\">{{lyteUiGetMonthOrYear(monthHeader1,\"M\")}}</span> <span class=\"lyteCalsCalYear\">{{lyteUiGetMonthOrYear(monthHeader1,\"Y\")}}</span> </button> </template> <template default=\"\"> <span aria-live=\"polite\" id=\"{{headerId1}}\">{{monthHeader1}}</span>  </template> </template> </div> <div class=\"lyteDateRPRightNav\"> <span role=\"button\" case=\"true\" class=\"lyteCalNav lyteCaldRgt\" tabindex=\"{{navtab}}\" aria-label=\"{{nextMonth}}\" __click=\"{{action('separatePrevious','M','cal1',event,'next')}}\" __keydown=\"{{action('nextKey','M',event,'cal1')}}\"> </span> <template is=\"if\" value=\"{{ltPropYear}}\"><template case=\"true\"><span role=\"button\" class=\"lyteCalNav lyteCalyearNavRgt\" tabindex=\"{{navtab}}\" aria-label=\"{{nextYear}}\" __click=\"{{action('separatePrevious','Y','cal1',event,'next')}}\" __keydown=\"{{action('nextKey','Y',event,'cal1')}}\"> </span></template></template> </div> </template> </lyte-calendar> </div> <div class=\"lyteDateRangePickerCol2\"> <lyte-calendar on-month-selected=\"{{method('monthSelect','2')}}\" lt-prop=\"{{ltPropCalendar}}\" lt-prop-header-type=\"{{ltPropHeaderType}}\" nav-yield=\"{{navYield2}}\" lt-prop-format=\"{{ltPropFormat}}\" lt-prop-max-date=\"{{ltPropMaxDate}}\" lt-prop-min-date=\"{{ltPropMinDate}}\" lt-prop-fill-rows=\"{{ltPropFillRows}}\" lt-prop-start-week-day=\"{{ltPropStartWeekDay}}\" class=\"dRPCalendar2\" on-viewdate-change=\"{{method('viewDateChange','cal2')}}\" lt-prop-disable-navigation=\"true\" header-id=\"{{lbind(headerId2)}}\" month-dropdown-id=\"{{lbind(monthDropdownId2)}}\" year-dropdown-id=\"{{lbind(yearDropdownId2)}}\" month-header=\"{{lbind(monthHeader2)}}\"> <template is=\"registerYield\" yield-name=\"navigator\"> <div class=\"lyteDateRPLeftNav\"> <template is=\"if\" value=\"{{ltPropYear}}\"><template case=\"true\"><span role=\"button\" case=\"true\" class=\"lyteCalNav lyteCalyearNavLft\" tabindex=\"{{navtab}}\" aria-label=\"{{previousYear}}\" __click=\"{{action('separatePrevious','Y','cal2',event)}}\" __keydown=\"{{action('prevKey','Y',event,'cal2')}}\"> </span></template></template> <span role=\"button\" class=\"lyteCalNav lyteCaldLft\" tabindex=\"{{navtab}}\" aria-label=\"{{previousMonth}}\" __click=\"{{action('separatePrevious','M','cal2',event)}}\" __keydown=\"{{action('prevKey','M',event,'cal2')}}\"> </span> </div> <div class=\"{{lyteUiDateRPHeaderClass(ltPropHeaderType)}}\"> <template is=\"switch\" value=\"{{ltPropHeaderType}}\"> <template case=\"dropdown\"> <lyte-dropdown on-before-show=\"{{method('addDropdownClass')}}\" on-show=\"{{method('editArrowPosition')}}\" lt-prop-callout=\"true\" class=\"monthDD\" lt-prop-tabindex=\"{{droptab1}}\" on-option-selected=\"{{method('optionSelected','cal2','M')}}\" lt-prop=\"{{ltPropDropdown}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateRangepickerDropdown\"> <lyte-drop-body> <template is=\"for\" items=\"{{monthNames}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <lyte-dropdown on-before-show=\"{{method('addDropdownClass')}}\" on-show=\"{{method('editArrowPosition')}}\" lt-prop-callout=\"true\" class=\"yearDD\" lt-prop-tabindex=\"{{droptab2}}\" on-option-selected=\"{{method('optionSelected','cal2','Y')}}\" lt-prop=\"{{ltPropDropdown}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-box class=\"lyteDateRangepickerDropdown\"> <lyte-drop-body> <template is=\"for\" items=\"{{years}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-value=\"{{item}}\">{{item}}</lyte-drop-item> </template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> <span class=\"lyteVisuallyHidden\" aria-live=\"polite\" id=\"{{headerId2}}\">{{monthHeader2}}</span> </template> <template case=\"drilldown\"> <button aria-label=\"{{lyteUiI18n('lyte.calendar.monthview.drilldown.button')}}\" tabindex=\"0\" class=\"lyteDrillCalHeaderButton\" __click=\"{{action('switchDrill',event,this,'2')}}\"> <span class=\"lyteCalsCalMonth\">{{lyteUiGetMonthOrYear(monthHeader2,\"M\")}}</span> <span class=\"lyteCalsCalYear\">{{lyteUiGetMonthOrYear(monthHeader2,\"Y\")}}</span> </button> </template> <template default=\"\"> <span aria-live=\"polite\" id=\"{{headerId2}}\">{{monthHeader2}}</span>  </template> </template> </div> <div class=\"lyteDateRPRightNav\"> <span role=\"button\" case=\"true\" class=\"lyteCalNav lyteCaldRgt\" tabindex=\"{{navtab}}\" aria-label=\"{{nextMonth}}\" __click=\"{{action('separatePrevious','M','cal2',event,'next')}}\" __keydown=\"{{action('nextKey','M',event,'cal2')}}\"> </span> <template is=\"if\" value=\"{{ltPropYear}}\"><template case=\"true\"><span role=\"button\" class=\"lyteCalNav lyteCalyearNavRgt\" tabindex=\"{{navtab}}\" aria-label=\"{{nextYear}}\" __click=\"{{action('separatePrevious','Y','cal2',event,'next')}}\" __keydown=\"{{action('nextKey','Y',event,'cal2')}}\"> </span></template></template> </div> </template> </lyte-calendar> </div> </div> </template></template> </template>",
	...
	data: function () {
		...
		return {
			...
			*/
			...
			/**
			 * @componentProperty {object} ltPropCalendar
			 * @default {}
			 * @version 3.109.0
			 */
