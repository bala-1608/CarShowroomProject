...
(function (window) {
    ...
    */
        ...
        _createClass(customElementPrototype, [{
                ...
                if (!fastRenderedProp) {
                    ...
                    if (this.$data) {
                        ...
                        for (var _key4 in initProperties) {
                            compData[_key4] = initProperties[_key4];
                        }
                    }
                    this.$data = compData;
            ...
            value: function afterConnected(fastRenderProp, ssrBind) {
                ...
                for (var _i8 = 0; _i8 < obsattr.length; _i8++) {
                    var _key5 = obsattr[_i8];
                    var prop = this.getProperty(_key5);
                ...
                if (this._initProperties) {
                    ...
                    for (var _key6 in initProperties) {
                        var actVal = void 0;
                        var _field = compInstance.__data[_key6];
                        if (_field && _field.type !== _LC.getDataType(initProperties[_key6]) && (initProperties[_key6] !== undefined || _field.type === "boolean")) {
                            actVal = _LC.typeCast(initProperties[_key6], compInstance.__data[_key6].type);
                        } else {
                            actVal = initProperties[_key6];
                        }
                        // if(field){
                        var error = _LC.handleValidation(compData, _key6, actVal, compInstance, true);
                        if (!error) {
                            compData[_key6] = actVal;
                            var customDtype;
                            ...
                            if (_field && /^(object|array)$/.test(_field.type) && _field.watch || customDtype) {
                                Lyte.establishObjectBinding(compData, _key6, undefined, undefined, undefined, _field.watch ? true : undefined);
                            }
                        }
                        // }
                    }
                ...
                if (this._initMethods) {
                    ...
                    for (var _key7 in initMethods) {
                        compInstance.$node._methods[_key7] = initMethods[_key7];
                    }
            ...
            value: function initializeMethod(node, actMethods) {
                ...
                for (var _key8 in actMethods) {
                    compInstance.methods[_key8] = actMethods[_key8];
                }
            ...
            value: function renderComponent(dynNode, preDefObj) {
                ...
                if (initProperties) {
                    for (var _key10 in initProperties) {
                        ...
                        var error = _LC.handleValidation(cmpData, _key10, actVal, component);
                        if (!error) {
                            cmpData[_key10] = actVal;
                        }
                    }
                }
                if (true) {
                                ...
                                case "attr":
                                    {
                                        ...
                                        var actionObj = {};
                                        for (var _key12 in attr) {
                                            if (attr[_key12].dynamicValue) {
                                                // let nodeValue = this.get(attr[key].dynamicValue);
                                                var _nodeValue = attr[_key12].newDynamicValue ? _LC.getDD(compData, attr[_key12].newDynamicValue) : this.get(attr[_key12].dynamicValue);

                                                if (fastRenderProp) {
                                                    fastRenderProp.data[attr[_key12].camelCase] = _nodeValue;
                                                    if (typeof _nodeValue == "string" && setAttr) {
                                                        _nodeValue = this.formatValue(_key12, _nodeValue);
                                                        str = str + _nodeValue + " ";
                                                    }
                                                } else {
                                                    _nodeValue = this.formatValue(_key12, _nodeValue);
                                            ...
                                            } else if (attr[_key12].helperInfo) {
                                                if (attr[_key12].helperInfo.name === "action") {
                                                    var actionName = attr[_key12].helperInfo.args[0];
                                                    ...
                                                    var actArgs = this.processArgs(this, attr[_key12], [], "__lyteEvent__", "__lyteNode__");
                                                    var actualAttrName = attr[_key12].globalEvent ? attr[_key12].name : attr[_key12].name.indexOf("-") !== -1 ? attr[_key12].name : attr[_key12].name.substr(2);
                                                    actionObj[actualAttrName] = { "name": boundName, "args": attr[_key12].helperInfo.args, "actArgs": actArgs, "globalEvent": attr[_key12].globalEvent ? true : false, "skipArgProcessing": true };
                                                } else if (attr[_key12].helperInfo.name === "method") {
                                                    ...
                                                    if (fastRenderProp) {
                                                        ...
                                                        (function () {
                                                            ...
                                                            var actArgs = _this8.processArgs(_this8, attr[_key12], [], "__lyteEvent__", "__lyteNode__");
                                                            ...
                                                            methods[attr[_key12].camelCase] = methodFunc;
                                                        })();
                                                    }
                                                } else {
                                                    var _nodeValue2 = this.processHelper({ name: attr[_key12].helperInfo.name, args: this.processArgs(this, attr[_key12], [], undefined, undefined, true) }, undefined);
                                                    if (fastRenderProp) {
                                                        fastRenderProp.data[attr[_key12].camelCase] = _nodeValue2;
                                                        if (typeof _nodeValue2 == "string" && setAttr) {
                                                            _nodeValue2 = this.formatValue(_key12, _nodeValue2);
                                                            str = str + _nodeValue2 + " ";
                                                        }
                                                    } else {
                                                        _nodeValue2 = this.formatValue(_key12, _nodeValue2);
                                ...
                                case "insertYield":
                                    {
                                        ...
                                        if (yieldObj) {
                                            ...
                                            for (var _key13 in contextSwitch) {
                                                psCmpData[_key13] = contextSwitch[_key13];
                                            }
                                            if (yieldObj._cx) {
            ...
            value: function renderNodes(toAppend, dynamicNodes, helperNode, options, establishBindings, returnVal, templateContent, yieldComp, initialRender) {
                ...
                for (var _i10 = 0; _i10 < dynamicNodes.length; _i10++) {
                    var info = dynamicNodes[_i10],
                        type = info.type,
                        pos = info.position,
                        dynamicN = content,
                        helperInfo = void 0;
                    ...
                    if (type === "componentDynamic") {
                        ...
                        this.bindNode(dynamicN, undefined, helperNode, options, dynamicNodes[_i10], processLast, establishBindings, undefined, dynamicNodes._cache, type, undefined, toBeInsMap);
                    } else if (type === "attr") {
                        ...
                        for (var _key14 in info.attr) {
                            ...
                            if (_attr && (_attr.dynamicValue || _attr.helperInfo)) {
                                ...
                                if (!_attr.globalEvent) {
                                    ...
                                    node = this.bindNode(dynamicN.attributes.getNamedItem(attrName), toBeRemoved, helperNode, options, _attr, undefined, establishBindings, undefined, dynamicNodes._cache, type, _i10);
                        ...
                        switch (type) {
                            case "for":
                                ...
                                _returnVal = this.updateForHelper(dynamicN, { "type": "default" }, options.node ? options : undefined, establishBindings, info._sta, undefined, initialRender);
                                break;
                            case "forIn":
                                dynamicN._ht = info._ht;
                                _returnVal = this.updateForInHelper(dynamicN, { "type": "default" }, options.node ? options : undefined, establishBindings, undefined, initialRender);
                                break;
                            case "component":
                                _returnVal = this.updateDynamicComponent(dynamicN, false, options.node ? options : undefined, establishBindings, _i10, helperNode);
                        }
                        if (_returnVal) {
                        ...
                        var _returnVal2 = this.updateSwitchHelper(type, dynamicN, options.node ? options : undefined, undefined, establishBindings, yieldComp, _id, toBeInsMap);
                        if (_returnVal2) {
                ...
                for (var _i11 = 0; _i11 < processLast.length; _i11++) {
                    var dynamicPosition = processLast[_i11].dynamicPositions;
                    ...
                    processLast[_i11].dynamicPositions = { startingNode: startingNode, length: childLen };
                }
                if (toBeInsMap.size) {
            ...
            value: function executeBlockHelpers(updateHelpers, node) {
                for (var _i12 = 0; _i12 < updateHelpers.length; _i12++) {
                    var lastNode = updateHelpers[_i12].lastNode;
                    ...
                    _insertBefore(parentNode, updateHelpers[_i12].toAppendMain, lastNode);
                    updateHelpers[_i12] = updateHelpers[_i12].lastNode;
            ...
            value: function updateBlockHelpers(updateHelpers, contextSwitchInfo) {
                for (var _i13 = 0; _i13 < updateHelpers.length; _i13++) {
                    switch (updateHelpers[_i13].getAttribute('is')) {
                        case "for":
                            this.updateForHelper(updateHelpers[_i13], { "type": "default" }, contextSwitchInfo);
                            break;
                        case "if":
                            this.updateSwitchHelper("if", updateHelpers[_i13], contextSwitchInfo);
                            break;
                        case "forIn":
                            this.updateForInHelper(updateHelpers[_i13], { "type": "default" }, contextSwitchInfo);
                            break;
                        case "switch":
                            this.updateSwitchHelper("switch", updateHelpers[_i13], contextSwitchInfo);
                            break;
                        case "component":
                            this.updateDynamicComponent(updateHelpers[_i13], false, contextSwitchInfo);
                            break;
                        case "insertYield":
                        ...
                        case "registerYield":
                            if (contextSwitchInfo) {
                                updateHelpers[_i13]._cx = contextSwitchInfo;
                            }
                            break;
                        default:
                            if (updateHelpers[_i13].tagName === "LYTE-YIELD") {
                                this.updateYield(updateHelpers[_i13], false, contextSwitchInfo);
                            }
            ...
            value: function removeHelpersSpecificIndex(node, index, destroyChild, type) {
                ...
                if (node._forContent[index]) {
                    for (var _i14 = 0; _i14 < node._forContent[index].length; _i14++) {
                        node._forContent[index][_i14].remove();
                    }
                    var self = this;
            ...
            value: function removeHelpers(node, update, direct, updateIndex, parentNode, type) {
                ...
                if (node._forContent) {
                    if (node.getAttribute("is") === "for") {
                        if (node._helpers) {
                            for (var _i15 = 0; _i15 < node._helpers.length; _i15++) {
                                for (var j = 0; j < node._helpers[_i15].length; j++) {
                                    this.removeHelpers(node._helpers[_i15][j], undefined, undefined, updateIndex, parentNode, type);
                                }
                                node._helpers[_i15] = [];
                            }
                        }
                        for (var _s = 0; _s < node._forContent.length; _s++) {
                            for (var _i16 = 0; _i16 < node._forContent[_s].length; _i16++) {
                                node._forContent[_s][_i16].remove();
                            }
                        }
                        ...
                        if (node._items.length) {
                            ...
                            for (var _i17 = 0; _i17 < node._items.length; _i17++) {
                                var dynProp = node._items[_i17]._dynamicProperty;
                            ...
                            if (prop) {
                                for (var _i18 = 0; _i18 < node._items.length; _i18++) {
                                    this.removeBindings(_defineProperty({}, _key16, node._items[_i18].itemProperty), _defineProperty({}, _key16, node._attributes.items[_i18]));
                                }
                            }
                        }
                        ...
                        if (node._helpers) {
                            ...
                            for (var _i19 = 0; _i19 < keys.length; _i19++) {
                                for (var _j = 0; _j < node._helpers[keys[_i19]].length; _j++) {
                                    this.removeHelpers(node._helpers[keys[_i19]][_j], undefined, undefined, updateIndex, parentNode, type);
                                }
                                node._helpers[keys[_i19]] = [];
                            }
                        }
                        for (var ind in node._forContent) {
                            for (var _i20 = 0; _i20 < node._forContent[ind].length; _i20++) {
                                node._forContent[ind][_i20].remove();
                            }
                        }
                    ...
                    if (node._caseContent) {
                        for (var _i21 = 0; _i21 < node._caseContent.length; _i21++) {
                            node._caseContent[_i21].remove();
                        }
                        ...
                        for (var _i22 = 0; _i22 < node._yieldContent.length; _i22++) {
                            node._yieldContent[_i22].remove();
                        }
                        node._dynamicProperty = {};
                    }
                    ...
                    for (var _key19 in node._renderedComponent) {
                        var comp = node._renderedComponent[_key19];
                        if (comp) {
            ...
            value: function updateDynamicComponent(node, update, contextSwitchInfo, establishBindings, idx, helperNode) {
                ...
                if (newComponent) {
                    //          let componentData = {};
                    for (var _i23 = 0; _i23 < node.attributes.length; _i23++) {
                        if (node.attributes[_i23].name !== "is" && node.attributes[_i23].name !== "component-name" && node.attributes[_i23].name !== "lyte-keep-alive") {
                            component.setAttribute(node.attributes[_i23].name, node.attributes[_i23].value);
                        }
                    }
            ...
            value: function updateForHelper(node, options, contextSwitchInfo, establishBindings, staticTempArr, yieldComp, initialRender) {
                        ...
                        case "remove":
                            {
                                ...
                                for (var _i24 = firstIndex, v = secondIndex; v > 0; v--, _i24++) {
                        ...
                        case "insert":
                            {
                                ...
                                for (var _i26 = firstIndex + secondIndex; _i26 < node._items.length; _i26++) {
                                    node._items[_i26]._cx.itemIndex = node._items[_i26]._cx.itemIndex + secondIndex;
                                }
                        ...
                        case "replace":
                            {
                                ...
                                for (var _i27 = firstIndex + secondIndex; _i27 < node._items.length; _i27++) {
                                    node._items[_i27]._cx.itemIndex = node._items[_i27]._cx.itemIndex + secondIndex - 1;
                                }
                        ...
                        case "splice":
                            {
                                ...
                                for (var _i28 = thirdIndex, j = 0; _i28 > 0; _i28--, j++) {
                                ...
                                for (var _i29 = firstIndex + secondIndex; _i29 < node._items.length; _i29++) {
                                    node._items[_i29]._cx.itemIndex = node._items[_i29]._cx.itemIndex + secondIndex - thirdIndex;
                                }
                        ...
                        case "update":
                            {
                                ...
                                for (var _i30 = 0; _i30 < node._items.length; _i30++) {
                                    this.removeHelpersSpecificIndex(node, _i30);
                ...
                if (options.type !== "remove") {
                    ...
                    for (var _k5 = firstIndexForIteration, _v4 = lastIndexForIteration; _v4 > 0; _k5++, _v4--) {
                        ...
                        node._items[_k5] = { "_dynamicProperty": {}, "itemProperty": {}, "indexProperty": {}, "propProperty": {}, "propPropertyDyn": {}, "propNodes": {} };
                ...
                if (updateIndexProperty) {
                    for (var _i31 = indexPropertyStartIndex; _i31 < node._items.length; _i31++) {
                        if (node._items[_i31].indexProperty) {
                            _LC.affectChanges(node._items[_i31].indexProperty);
                        }
                    }
                }
            ...
            value: function renderPromiseNodes(trueNode, dynamicNodes, node, optns, establishBindings, returnVal, templateContent, yieldComp, toAppendMain) {
                ...
                for (var _i32 = 0; _i32 < contentArr.length; _i32++) {
                    if (contentArr[_i32].nodeType == 11) {
                        node._promiseContent = node._promiseContent.concat(Array.from(contentArr[_i32].childNodes));
                    } else {
                        node._promiseContent.push(contentArr[_i32]);
                    }
            ...
            value: function updateSwitchHelper(type, node, contextSwitchInfo, update, establishBindings, yieldComp, id, toBeInsMap) {
                ...
                node._caseContent = [];
                var toAppendMain = createDocFragment();;
                for (var _i33 = 0; _i33 < contentArr.length; _i33++) {
                    if (contentArr[_i33].nodeType == 11) {
                        //                for(let j=0;j<contentArr[i].childNodes.length;j++) {
                        //                    node._caseContent.push(contentArr[i].childNodes[j]);
                        //                }
                        node._caseContent = node._caseContent.concat(Array.from(contentArr[_i33].childNodes));
                    } else {
                        node._caseContent.push(contentArr[_i33]);
                    }
                    toAppendMain.append(contentArr[_i33]);
            ...
            value: function callObservers(boundValue, key) {
                ...
                if (observers) {
                    for (var _i34 = 0; _i34 < observers.length; _i34++) {
                        if (key.indexOf('.') === -1 || observers[_i34].path === key) {
                            this["_" + observers[_i34].functionName].apply(this);
                        }
                    }
                }
            }
            ...
            value: function getProperty(key) {
                ...
                defProp(property, '_path', { enumerable: false, value: arr[0] });
                for (var _i35 = 1; _i35 < arr.length; _i35++) {
                    if (arr[_i35].startsWith("'") || arr[_i35].startsWith('"')) {
                        //added check
                        arr[_i35] = arr[_i35].substring(1, arr[_i35].length - 1);
                    }
                    if (!property[arr[_i35]]) {
                        property[arr[_i35]] = {};
                        defProp(property[arr[_i35]], '_path', { enumerable: false, value: property._path + "." + arr[_i35] });
                    }
                    property = property[arr[_i35]];
                }
                return property;
            }
            //updN
            ...
            value: function updateNode(node, updatePath, options) {
                                ...
                                if (nodes.length === 0) {
                                    if (helperNode.getAttribute("is") === "if") {
                                        ...
                                        if (helperNode._items) {
                                            ...
                                            for (var _i36 = 0; _i36 < helperNode._items.length; _i36++) {
                                                if (helperNode._items[_i36]._dynamicProperty && helperNode._items[_i36]._dynamicProperty[multipleProp.actProp._path]) {
                                                    removeHelper = false;
                                                    break;
                                                }
                                            }
                ...
                if (isDirectiveNode) {
                    ...
                    parentNodes.push(pN);
                    for (var _i37 = 0; _i37 < parentNodes.length; _i37++) {
                        var parentNode = parentNodes[_i37];
                        if (parentNode.set) {
            ...
            value: function handleBreak(contextSwitchInfo, options) {
                if (contextSwitchInfo) {
                    ...
                    for (var j = breakIndex; j < endIndex; j++) {
                        ...
                        for (var _i38 = 0; _i38 < currentForContent.length; _i38++) {
                            currentForContent[_i38].remove();
                            if (currentForContent[_i38]._forContent || currentForContent[_i38]._caseContent) {
                                this.removeHelpers(currentForContent[_i38]);
                            }
                        }
                        forContent[j] = [];
            ...
            value: function processArgs(scope, dynN, dynamicValues, event, node, newCompile, cache, unboundFlag) {
                ...
                for (var _i39 = 0; _i39 < args.length; _i39++) {
                    if (args[_i39] && args[_i39].type) {
                        this.internalHelpers(scope, args, _i39, dynamicValues, event, node, newCompile, cache, unboundFlag);
                    } else {
                        if (!this.isEmptyString(args[_i39])) {
                            if (args[_i39].startsWith("'") && args[_i39].endsWith("'")) {
                                args[_i39] = args[_i39].substr(1, args[_i39].length - 2);
                            } else {
                                args[_i39] = args[_i39].trim();
                                var dynamicVals = [];
                                if (args[_i39] === "event" && event) {
                                    args[_i39] = widget && widgetMap.has(widget) ? widgetMap.get(widget).getClone(event) : event;
                                } else if (args[_i39] === "this" && node) {
                                    var thisNode = node.nodeType === 2 ? node.ownerElement : node;
                                    args[_i39] = widget && widgetMap.has(widget) ? widgetMap.get(widget).getClone(thisNode) : thisNode;
                                } else {
                                    args[_i39] = _LC.get(scope.component.data, args[_i39], dynamicVals, cache);
                                }
                                if (unboundFlag !== true) {
                            ...
                            if (args[_i39] instanceof Array) {
                                args[_i39] = _LC.getDD(scpData, args[_i39]);
                            }
                        }
                    }
                }
            ...
            value: function getArgValues(argNames, properties) {
                var argValueArray = [];
                for (var _i40 = 0; _i40 < argNames.length; _i40++) {
                    argValueArray.push(properties[argNames[_i40]].value);
                }
            ...
            value: function registerYields() {
                ...
                var lazyYields = [];
                for (var _i41 = 0; _i41 < yields.length; _i41++) {
                    var yld = yields[_i41];
            ...
            value: function actualConnectedCallback() {
                ...
                this.__lyteIgnore = true;
                for (var _i42 = attributes.length - 1; _i42 > -1; _i42--) {
                    var camelCase = LyteComponent.String.toCamelCase(attributes[_i42].nodeName);
                    if (dataDef[camelCase] && dataDef[camelCase].hideAttr) {
                        this.removeAttribute(attributes[_i42].nodeName);
                    }
                }
            ...
            value: function onCallBack(name) {
                ...
                if (callbacks) {
                    for (var _i43 = 0; _i43 < callbacks.length; _i43++) {
                        try {
                            callbacks[_i43].value.call(this.component);
                        } catch (e) {
                            _Lyte.error(e);
                        }
                    }
            ...
            value: function establishObserverBindings() {
                ...
                for (var _i44 = 0; _i44 < observers.length; _i44++) {
                    var props = observers[_i44].properties;
                    for (var j = 0; j < props.length; j++) {
                        var actProp = void 0;
                        var isArrayObserver = false;
                        if (props[j].indexOf('.[]') !== -1) {
                        ...
                        actProp._observers.add({ callee: this, observer: observers[_i44], isArrayObserver: isArrayObserver });
                    }
                }
            }
        }, {
            ...
            value: function removeBindings(properties, actualData) {
                var del = "delete";
                for (var _i45 in properties) {
                    var actData = actualData[_i45];
                    if (actData && actData._bindings) {
                        actData._bindings[del](properties[_i45]);
                    ...
                    if (_typeof(properties[_i45]) === "object" && actData) {
                        this.removeBindings(properties[_i45], actData);
                    }
                }
            }
        }, {
                        ...
                        if (helper.hasAttribute("lyte-keep-alive")) {
                            ...
                            for (var j = 0; j < objKeys.length; j++) {
                                ...
                                if (_key24 !== helper._currentComponent) {
                                    ...
                                    var comp = helper._renderedComponent[_key24];
                                    comp.constructor.prototype._disconnectedCallback.call(comp);
                                    comp.remove();
                                }
                            }
            ...
            value: function _disconnectedCallback() {
                ...
                if (pve.length) {
                    for (var _i46 = 0; _i46 < pve.length; _i46++) {
                        var actTemp = _LC.getActViewPortTemplate(pve[_i46]);
            ...
            value: function dasherizeObservedAttributes() {
                var newArr = [];
                for (var _i47 = 0; _i47 < this._observedAttributes.length; _i47++) {
                    newArr[_i47] = _LC.String.dasherize(this._observedAttributes[_i47]);
                }
            ...
            value: function updateValue(property, path, value) {
                ...
                for (var _i48 = 0; _i48 < pathVals.length - 1; _i48++) {
                    context = context[pathVals[_i48]];
                }
                            ...
                            case 18:
                                ...
                                return function () {
                                    ...
                                    if (_this9.component._templateAttributes && _this9.component._templateAttributes.attr) {
                                        ...
                                        try {
                                            for (var _i50 = 0; _i50 < attributesT.length; _i50++) {
                                                var attrName = attributesT[_i50].name;
                                                if (!_this9.component._templateAttributes.attr[attrName] && attrName !== "tag-name" && attrName !== "use-strict") {
                                                    _this9.component._templateAttributes.attr[attrName] = { "name": attrName, "staticValue": attributesT[_i50].value };
            ...
            value: function splitTextNodes(node) {
                if (node && node.childNodes && node.childNodes.length) {
                    for (var _i51 = node.childNodes.length - 1; _i51 >= 0; _i51--) {
                        this.splitTextNodes(node.childNodes[_i51]);
                    }
                }
                ...
                if (node.nodeType === node.TEXT_NODE) {
                    ...
                    if (_nodeValue4) {
                        ...
                        var newNodeArray = [];
                        for (var _i52 = 0; _i52 < mustacheValues.length; _i52++) {
                            var mustacheStartIndex = _nodeValue4.indexOf(mustacheValues[_i52]);
                            var mustacheEndIndex = mustacheStartIndex + mustacheValues[_i52].length;
                        ...
                        if (_Lyte._rwpf && node.parentNode.nodeName === "#document-fragment") {
                            for (var _i53 = 0; _i53 < newNodeArray.length; _i53++) {
                                _insertBefore(node.parentNode, newNodeArray[_i53], node);
                            }
                            node.remove();
                        } else {
    ...
    var LyteComponent = (_LyteComponent2 = {
        ...
        for (var _key26 in def) {
            if (def[_key26] && def[_key26].type === "observer") {
                ...
                customCrmComponent.component._observers.push(def[_key26]);
                ...
                for (var k = 0; k < props.length; k++) {
                    ...
                    def[_key26].fnName = _key26;
                    customCrmComponent.component._callBacks[props[k]].push(def[_key26]);
                }
                if (def[_key26].observes) {
                    def[_key26].observes.fnName = _key26;
                    customCrmComponent.component._observers.push(def[_key26].observes);
                }
            } else {
        ...
        for (var _i54 = 0; _i54 < mixinslen; _i54++) {
            for (var _item3 in mixinsToBeUsed[_i54]) {
                if (_item3 === "actions") {
                    Object.assign(actionsFromMixin, mixinsToBeUsed[_i54][_item3]);
                } else if (_item3 === "methods") {
                    Object.assign(methodsFromMixin, mixinsToBeUsed[_i54][_item3]);
                } else {
                    newDefinition[_item3] = mixinsToBeUsed[_i54][_item3];
                }
            }
        }
        ...
        var customArgs = [];
        if (arguments.length > 1) {
            for (var _i55 = 1; _i55 < arguments.length; _i55++) {
                customArgs.push(arguments[_i55]);
            }
        }
        //wait for release
        ...
        */
        ...
        if (actObj) {
            ...
            if (eventsObj) {
                ...
                var _val = eventsObj.apply(_context3, args);
        ...
        if (value && typeof value !== "string" && typeof value !== "boolean" && typeof value !== "number") {
            ...
            if (oldValue && (typeof oldValue === 'undefined' ? 'undefined' : _typeof(oldValue)) === "object" && oldValue._bindings) {
                ...
                if (fromComponent && fcmpData === object && property.indexOf('.') === -1 && !window.isLyteWidget) {
                    ...
                    if (object._bindings) {
                        ...
                        for (var _i56 = 0; _i56 < oldbind.length; _i56++) {
                            var _item5 = oldbind[_i56][property];
                            if (_item5) {
            ...
            if (oldValue && (typeof oldValue === 'undefined' ? 'undefined' : _typeof(oldValue)) === "object" && oldValue._bindings && object._bindings) {
                ...
                for (var _i58 = 0; _i58 < _objbind.length; _i58++) {
                    var _item7 = _objbind[_i58];
                    if (_item7[property]) {
            ...
            if (object._bindings) {
                ...
                for (var _i59 = 0; _i59 < _objbind2.length; _i59++) {
                    var _item8 = _objbind2[_i59];
                    if (_item8[property]) {
        ...
        if ((typeof property === 'undefined' ? 'undefined' : _typeof(property)) === "object") {
            if (_Lyte.isRecord(object) && !fromStore && !object.$.isCloned) {
                ...
                for (var _key28 in property) {
                    ...
                    _LC.set(object, _key28, property[_key28], value, fromStore, fromParent);
                }
            }
        } else {
        ...
        var commands = [];
        for (var _i60 = 0; _i60 < arrayB.length; _i60++) {
            // var targetIndex = arrayA.findIndex((element) => element === arrayB[i]);
            var arrBi = arrayB[_i60];
            if (arrayB[_i60] && arrayB[_i60].__target__) {
                arrBi = arrayB[_i60].__target__;
            }
        ...
        for (var _i61 = arrayA.length - 1; _i61 >= arrayB.length; _i61--) {
            commands.push({
                type: 'Remove',
                element: arrayA[_i61]
            });
            arrayA.splice(_i61, 1);
        }
        ...
        if (bindings) {
            ...
            for (var _i62 = 0; _i62 < bind.length; _i62++) {
                var binding = bind[_i62];
                        ...
                        for (var _i63 = 0; _i63 < objbind.length; _i63++) {
                            ...
                            if (_item9._forHelpers) {
                                ...
                                for (var _j4 = 0; _j4 < helperbind.length; _j4++) {
                                    ...
                                    for (var _i64 = index, _j5 = 0; _i64 < finalIndex; _i64++, _j5++) {
                                        _LC.removeSelectedBindingDeep(_defineProperty({}, itemValue, helper._items[_i64].itemProperty), _defineProperty({}, itemValue, deletedItems[_j5]));
                                    }
                                    var contextSwitchArray = [];
                            ...
                            for (var _key29 in _item9) {
                                ...
                                if (!isNaN(parsedKey) && _cond) {
                                    ...
                                    this.removeSelectedBindingDeep(_item9[_key29], _oldObject);
                                    if (_item9[_key29]._forHelpers) {
                                        var bindfor = _item9[_key29]._forHelpers.toArrayLyte();
                                    ...
                                    if (array[parsedKey] && _typeof(array[parsedKey]) === "object") {
                                        ...
                                        this.establishBindings({ "dummy": _item9[_key29] }, { "dummy": array[parsedKey] });
                                    }
                                    this.affectChanges(_item9[_key29], undefined, _oldObject, undefined, array[parsedKey]);
                                    if (options.secondIndex == 1) {
                                        break;
                                    }
                                }
            ...
            case "splice":
                {
                    ...
                    var _deletedItems = array.splice.apply(array, [_index2, toBeDeleted].concat(_args2));
                    var _options = { "firstIndex": _index2, "secondIndex": _args2.length, "thirdIndex": toBeDeleted, "type": "splice" };
                    //All references updated by now
                    ...
                    if (array._bindings) {
                        ...
                        for (var _i66 = 0; _i66 < _objbind3.length; _i66++) {
                            var _item10 = _objbind3[_i66];
                            if (_item10._forHelpers) {
                                ...
                                for (var _j6 = 0; _j6 < _helperbind.length; _j6++) {
                                    ...
                                    for (var _i67 = _index2, _j7 = 0; _i67 < _finalIndex; _i67++, _j7++) {
                                        _LC.removeSelectedBindingDeep(_defineProperty({}, _itemValue, _helper._items[_i67].itemProperty), _defineProperty({}, _itemValue, _deletedItems[_j7]));
                                    }
                            ...
                            for (var _key30 in _item10) {
                                var _parsedKey = parseInt(_key30);
                                var cond = _options.secondIndex == _options.thirdIndex ? _key30 >= _options.firstIndex && _key30 < _options.firstIndex + _options.secondIndex : _parsedKey >= _options.firstIndex;
                                if (!isNaN(_parsedKey) && cond) {
                                    ...
                                    this.removeSelectedBindingDeep(_item10[_key30], _oldObject2);
                                    if (_item10[_key30]._forHelpers) {
                                        var _bindfor = _item10[_key30]._forHelpers.toArrayLyte();
                                    ...
                                    if (array[_parsedKey] && _typeof(array[_parsedKey]) === "object") {
                                        ...
                                        this.establishBindings({ "dummy": _item10[_key30] }, { "dummy": array[_parsedKey] });
                                    }
                                    this.affectChanges(_item10[_key30], undefined, _oldObject2, undefined, array[_parsedKey]);
                                }
                            }
                        }
                    }
                    obsObj = { type: 'array', index: _index2, insertedItems: _args2, removedItems: _deletedItems };
                    _LC.bindWatchObj(watch, array, _args2, _deletedItems, _index2);
                    _LC.callArrayObservers(array, obsObj, callLengthObserver, initialArrLength);
            ...
            case "remove":
                {
                    ...
                    if (array._bindings) {
                        ...
                        for (var _i68 = 0; _i68 < _objbind4.length; _i68++) {
                            var _item12 = _objbind4[_i68];
                            if (_item12._forHelpers) {
                                ...
                                for (var _j8 = 0; _j8 < _helperbind2.length; _j8++) {
                                    ...
                                    for (var _i69 = _index3, _j9 = 0; _i69 < _finalIndex2; _i69++, _j9++) {
                                        _LC.removeSelectedBindingDeep(_defineProperty({}, _itemValue2, _helper2._items[_i69].itemProperty), _defineProperty({}, _itemValue2, _deletedItems2[_j9]));
                                    }
                            ...
                            for (var _key31 in _item12) {
                                ...
                                if (!isNaN(_parsedKey2) && _parsedKey2 >= _options2.firstIndex) {
                                    ...
                                    this.removeSelectedBindingDeep(_item12[_key31], _oldObject3);
                                    if (_item12[_key31]._forHelpers) {
                                        var _bindfor2 = _item12[_key31]._forHelpers.toArrayLyte();
                                    ...
                                    if (array[_parsedKey2] && _typeof(array[_parsedKey2]) === "object") {
                                        ...
                                        this.establishBindings({ "dummy": _item12[_key31] }, { "dummy": array[_parsedKey2] });
                                    }
                                    this.affectChanges(_item12[_key31], undefined, _oldObject3, undefined, array[_parsedKey2]);
                                }
                            }
                        }
                    }
            ...
            case "insertAt":
                {
                    ...
                    for (var _i70 = _index4; _i70 > array.length; _i70--) {
                        _args3.unshift(undefined);
                        _index4--;
                    }
                    var _options3 = { "firstIndex": _index4, "secondIndex": _args3.length, "type": "insert" };
                    array.splice.apply(array, [_index4, 0].concat(_args3));
                    if (array._bindings) {
                        var arrbind = array._bindings.toArrayLyte();
                        for (var _i71 = 0; _i71 < arrbind.length; _i71++) {
                            var _item14 = arrbind[_i71];
                            ...
                            for (var _key32 in _item14) {
                                var _parsedKey3 = parseInt(_key32);
                                if (!isNaN(_parsedKey3) && _parsedKey3 >= _options3.firstIndex) {
                                    this.removeSelectedBindingDeep(_item14[_key32], array[_parsedKey3 + _options3.secondIndex]);
                                    if (_item14[_key32]._forHelpers) {
                                        var _bindfor3 = _item14[_key32]._forHelpers.toArrayLyte();
                                    ...
                                    if (array[_parsedKey3] && _typeof(array[_parsedKey3]) === "object") {
                                        ...
                                        this.establishBindings({ "dummy": _item14[_key32] }, { "dummy": array[_parsedKey3] });
                                    }
                                    this.affectChanges(_item14[_key32], undefined, array[_parsedKey3 + _options3.secondIndex], undefined, array[_parsedKey3]);
                                }
                            }
                        }
                    }
            ...
            case "sort":
                {
                    ...
                    if (array._bindings) {
                        ...
                        for (var _i72 = 0; _i72 < _arrbind.length; _i72++) {
                            var _item16 = _arrbind[_i72];
        ...
        if (array._bindings) {
            ...
            for (var _i73 = 0; _i73 < objbind.length; _i73++) {
                var binding = objbind[_i73];
                var path = objbind[_i73]._path;
        ...
        for (var _i74 = 0; _i74 < objbind.length; _i74++) {
            var _item17 = objbind[_i74];
            if (_item17[property]) {
        ...
        for (var _i75 = 0; _i75 < props.length; _i75++) {
            ...
            currentProp = currentProp[props[_i75 + 1]];
            currentValue = currentValue[props[_i75 + 1]];
        }
                    ...
                    for (var j = 0; j < nodes.length; j++) {
                        ...
                        if (helper && helper.tagName === "TEMPLATE" && helper.getAttribute("is") === "for") {
                            if (helper._items) {
                                ...
                                for (var _i76 = 0; _i76 < helper._items.length; _i76++) {
                                    var data = actualData[_i76];
                                    var _item19 = helper.getAttribute("item");
                                    if (data) {
                                        if (_typeof(helper._items[_i76]) === "object") {
                                            this.establishBindings(helper._items[_i76].itemProperty, _defineProperty({}, _item19, data));
                                        }
                                    }
                                }
                            }
        ...
        for (var _i77 in properties) {
            var actData = actualData[_i77];
            if (!actData || typeof actData === "string" || typeof actData === "number" || typeof actData === "boolean") {
                ...
                // }
                addBindings(actData, properties[_i77]);
                if (_typeof(properties[_i77]) === "object") {
                    this.establishBindings(properties[_i77], actData);
                }
            }
        }
        ...
        for (var _i78 in binding) {
            var actData = void 0;
            if (actualData) {
                actData = actualData[_i78];
            }
            if (actData && actData._bindings) {
                deleteBindingCheckSize(actData, "_bindings", binding[_i78]);
            }
            if (_typeof(binding[_i78]) === "object") {
                this.removeSelectedBindingDeep(binding[_i78], actData, fromDisConnect);
            }
        }
        if (fromDisConnect) {
        ...
        if (binding && binding._forHelpers) {
            ...
            for (var _i79 = 0; _i79 < objbind.length; _i79++) {
                ...
                if (fH.getAttribute("is") === "for") {
                    ...
                    for (var _i80 = 0; _i80 < itemCases.length; _i80++) {
                        this.removeSelectedBindingDeep(itemCases[_i80].itemProperty, items[_i80], fromDisConnect);
                    }
                } else {
        ...
        if (item._dynamicNodes) {
            for (var _i81 = 0; _i81 < item._dynamicNodes.length; _i81++) {
                item._dynamicNodes[_i81]._callee.updateNode(item._dynamicNodes[_i81], item._path, options);
            }
        }
        ...
        if (item._helperNodes) {
            ...
            for (var _s4 = 0; _s4 < itemHelperNodes.length; _s4++) {
                ...
                if (itemHelperNodes[_s4].getAttribute("is") === "for" && itemHelperNodes[_s4]._items) {
                    ...
                    for (var _i82 = 0; _i82 < itemHelperNodes[_s4]._items.length; _i82++) {
                        cmpData[itemValue] = items[_i82];
                        cmpData[indexValue] = _i82;
                        callee._properties[itemValue] = itemHelperNodes[_s4]._items[_i82].itemProperty;
                        if (itemHelperNodes[_s4]._items[_i82]._dynamicProperty[propPath]) {
                            nodes = itemHelperNodes[_s4]._items[_i82]._dynamicProperty[propPath];
                    ...
                    for (var _key34 in itemHelperNodes[_s4]._items) {
                        _cmpData4[_itemValue4] = object[_key34];
                        _cmpData4[_indexValue] = _key34;
                        _callee5._properties[_itemValue4] = itemHelperNodes[_s4]._items[_key34].itemProperty;
                        if (itemHelperNodes[_s4]._items[_key34]._dynamicProperty[propPath]) {
                            nodes = itemHelperNodes[_s4]._items[_key34]._dynamicProperty[propPath];
                            for (var _i84 = 0; _i84 < nodes.length; _i84++) {
                                nodes[_i84]._callee.updateNode(nodes[_i84], propPath, options);
                            }
                        }
                    }
                    ...
                    if (nodes.length) {
                        ...
                        for (var _i85 = 0; _i85 < nodes.length; _i85++) {
                            nodes[_i85]._callee.updateNode(nodes[_i85], item._path, options);
                        }
        ...
        if (item._observers) {
            ...
            if (cond) {
                for (var _i86 = 0; _i86 < objbind.length; _i86++) {
                    var observer = objbind[_i86];
        ...
        if (cache && cache.hasOwnProperty(path)) {
            ...
            try {
                ...
                for (var _i87 = 1; _i87 < _arr4.length; _i87++) {
                    var locVal = _arr4[_i87];
        ...
        if (typeof arg0 === "string") {
            ...
            for (var _key37 in arg0) {
                this.set(_key37, arg0[_key37], arg1);
            }
        }
        ...
        if (node) {
            if (typeof arg0 === "string") {
                ...
                for (var _key39 in arg0) {
                    node._methods[_key39] = arg0[_key39];
                }
            }
        }
        ...
        "attachEvents": function attachEvents(thisRef) {
            ...
            for (var _i88 = 0; _i88 < len; _i88++) {
                thisRef.addEventListener(toAddEvents[_i88].eventName, toAddEvents[_i88].listener, toAddEvents[_i88].options);
            }
            //lbind event
        ...
        "save": {
            ...
            afterRender: function afterRender(node, comp, dirObjProp, options, initialRender) {
                ...
                var _loop = function _loop(_key40) {
                    var cxObj = node._cx;
                    var parentForNode = node;
                    while (cxObj) {
                        if (cxObj.type == "for" || cxObj.type == "forIn") {
                            parentForNode = cxObj.node;
                            var parentPropNodes = cxObj.node._propNodes[_key40];
                            if (cxObj.node._propNodes[_key40]) {
                                if (options.type != "default" && node.getAttribute("is") == "for") {
                                    ...
                                    if (oldbindings) {
                                        ...
                                        _this14.establishBindingsArr(bindArr, node._propNodes[_key40]);
                                    }
                                }
                                parentPropNodes[cxObj.itemIndex] = node._propNodes[_key40];
                                _this14.affectChangesArr(parentForNode._items[cxObj.itemIndex].propProperty[_key40]);
                                if (node.getAttribute("is") == "for") {
                                    _this14.establishBindingsArr(parentForNode._items[cxObj.itemIndex].propProperty[_key40], parentForNode._propNodes[_key40][cxObj.itemIndex]);
                                }
                            } else if (!cxObj.node._propNodes[_key40]) {
                                if (cxObj.node.getAttribute("is") == "forIn") {
                                    parentPropNodes = cxObj.node._propNodes[_key40] = {};
                                } else {
                                    parentPropNodes = cxObj.node._propNodes[_key40] = [];
                                }
                                parentPropNodes[cxObj.itemIndex] = node._propNodes[_key40];
                            ...
                            if (!cxObj.node._childProp) {
                                cxObj.node._childProp = [_key40];
                            } else if (cxObj.node._childProp.indexOf[_key40] == -1) {
                                cxObj.node._childProp.push(_key40);
                            }
                        }
                    ...
                    if (parentForNode) {
                        comp.$data[_key40] = parentForNode._propNodes[_key40];
                        if (!comp._propProperty[_key40]) {
                            comp._propProperty[_key40] = [];
                        }
                        if (options.type == "update" || options.type == "default") {
                            if (options.type == "update") {
                                var bind = comp.$data[_key40]._bindings;
                                if (bind) {
                                    var _bindArr = bind.toArrayLyte();
                                    _bindArr.forEach(function (bind) {
                                        if (comp._propProperty[_key40].indexOf(bind) == -1) {
                                            comp._propProperty[_key40].push(bind);
                                            comp._propProperty[_key40].push([]);
                                        }
                                        if (node.getAttribute("is") == "forIn") {
                                            _LCSV.establishBindingsArr(_bindArr, parentForNode._propNodes[_key40]);
                                        }
                                    });
                                }
                            } else {
                                var compProp = dirObjProp.data[_key40];
                                if (initialRender && compProp && Object.keys(compProp).length && comp._propProperty[_key40].indexOf(compProp) == -1) {
                                    ...
                                    if (Array.isArray(compProp)) {
                                        ...
                                        comp._propProperty[_key40].push(compProp);
                                    }
                                }
                            }
                        }
                ...
                for (var _key40 in node._propNodes) {
                    _loop(_key40);
                }
            },
            ...
            removeInChild: function removeInChild(comp, node, propName, index, data, destroy) {
                ...
                if (node._helpers) {
                    var _loop3 = function _loop3(_i89) {
                        for (var j = 0; j < node._helpers[_i89].length; j++) {
                            var currentNode = node._helpers[_i89][j];
                            _this17.removeInChild(comp, currentNode, propName, _i89, data, destroy);
                            var propPropertyArr = node._items[_i89].propProperty[propName];
                            if (propPropertyArr) {
                                propPropertyArr.forEach(function (binding) {
                                    //eslint-disable-line no-loop-func
                                    _LC.removeSelectedBindingDeep(binding, node._propNodes[propName][_i89]);
                                });
                            }
                        }
                    };

                    for (var _i89 = 0; _i89 < node._helpers.length; _i89++) {
                        _loop3(_i89);
                    }
                }
            },
            ...
            addInChild: function addInChild(comp, node, propName, i) {
                if (node._helpers) {
                    for (var _i90 = 0; _i90 < node._helpers.length; _i90++) {
                        for (var j = 0; j < node._helpers[_i90].length; j++) {
                            var currentNode = node._helpers[_i90][j];
            ...
            forIn: {
                ...
                update: function update(node) {
                    if (node._propNodes && Object.keys(node._propNodes).length) {
                        for (var _key41 in node._items) {
                            for (var propName in node._propNodes) {
                                var propArr = node._propNodes[propName];
                                // propArr.shift();
                                propArr[_key41] = null;
                                delete propArr[_key41];
            ...
            for: {
                    ...
                    if (newPropObj.length) {
                        if (node.getAttribute("is") == "for") {
                            ...
                            if (spliceArr[1] == 0) {
                                ...
                                for (var _i91 = gonnaInsertPos; _i91 < node._propNodes[propName].length; _i91++) {
                                    //af check for forin
                                    _LCSV.removeInParent(node._callee, node, propName, _i91, node._propNodes[propName][_i91]);
                                ...
                                // so need to update all next indexes
                                for (var _i92 = gonnaInsertPos; _i92 < node._propNodes[propName].length; _i92++) {
                                    _LCSV.removeInParent(node._callee, node, propName, _i92, node._propNodes[propName][_i92]);
                                }
                            }
                        }
                    }
                ...
                afterUpdateSpecific: function afterUpdateSpecific(node, spliceArr, newPropObj, propName) {
                    ...
                    if (spliceArr[1] == 0) {
                        // inserting bt no deletion
                        // so need to update all next indexes
                        for (var _i93 = gonnaInsertPos + newPropObj.length; _i93 < node._propNodes[propName].length; _i93++) {
                            // afcheck forincase
                            _LCSV.addInParent(node._callee, node, propName, _i93, node._propNodes[propName][_i93]);
                            _LCSV.addInChild(node._callee, node, propName, _i93, node._propNodes[propName][_i93]);
                        }
                    } else if (newPropObj.length) {
                        if (newPropObj.length != spliceArr[1]) {
                            // inserting different val and deletion different val
                            // so need to update all next indexes
                            for (var _i94 = gonnaInsertPos + newPropObj.length; _i94 < node._propNodes[propName].length; _i94++) {
                                _LCSV.addInParent(node._callee, node, propName, _i94, node._propNodes[propName][_i94]);
                                _LCSV.addInChild(node._callee, node, propName, _i94, node._propNodes[propName][_i94]);
                            }
                        }
                    } else {
            ...
            afterConnect: function afterConnect(comp) {
                if (comp._callee) {
                    ...
                    if ((propSave || dataSave) && !comp.__updateProp) {
                        ...
                        this.addNodeLazy([_obj9], comp._callee, undefined, comp, comp._cx ? comp._cx.node : undefined, undefined, comp._cx);
                    }
                }
            },
            ...
            removeData: function removeData(comp) {
                if (comp._propProperty) {
                    for (var _key42 in comp._propProperty) {
                        comp._propProperty[_key42] = null;
                    }
                }
            }
        },
        "hide": {
            ...
            rmHelpersSpecificIndex: function rmHelpersSpecificIndex(node, index) {
                if (typeof index == 'number' && node._hiddenTemplate[index] && node._hiddenTemplate.length) {
                    for (var _i95 in node._hiddenTemplate[index]) {
                        node._hiddenTemplate[index][_i95].disconnectedCallback();
                    }
                    if (node.getAttribute("is") == "for") {
            ...
            forRmHelpers: function forRmHelpers(node) {
                if (node._hiddenTemplate && node._hiddenTemplate.length) {
                    for (var _i96 = 0; _i96 < node._hiddenTemplate.length; _i96++) {
                        for (var j = 0; j < node._hiddenTemplate[_i96].length; j++) {
                            node._hiddenTemplate[_i96][j].disconnectedCallback();
                        }
                        node._hiddenTemplate[_i96] = [];
                    }
            ...
            addHiddenBoundEvents: function addHiddenBoundEvents(compNode, content) {
                ...
                for (var _i97 = 0; _i97 < content.childNodes.length; _i97++) {
                    if (compNode._boundEvents) {
                        content.childNodes[_i97]._hiddenBoundEvents = compNode._boundEvents;
                        if (content.childNodes[_i97]._boundEvents) {
                            content.childNodes[_i97]._hiddenBoundFlag = true;
                        }
                    }
                }
            },
            callDisconnectedCallback: function callDisconnectedCallback(node) {
                for (var _i98 = 0; _i98 < node._hiddenTemplate.length; _i98++) {
                    node._hiddenTemplate[_i98].disconnectedCallback();
                }
                node._hiddenTemplate = [];
            },
            ...
            case "attr":
                {
                    ...
                    for (var _i100 = 0; _i100 < node.attributes.length; _i100++) {
                        if (node.attributes[_i100].nodeValue.indexOf("{{") !== -1) {
                            var val = node.attributes[_i100].nodeValue;
                            ...
                            if (actObj && (actObj.name === "action" || actObj.name === "method") && /^(onfocus|onfocusin|onfocusout|onresize|onscroll|onclick|ondblclick|onmousedown|onmouseup|onmousemove|onmouseover|onmouseout|onchange|onselect|onsubmit|onkeydown|onkeypress|onkeyup|oncontextmenu|__focus|__focusin|__focusout|__resize|__scroll|__click|__dblclick|__mousedown|__mouseup|__mousemove|__mouseover|__mouseout|__change|__select|__submit|__keydown|__keypress|__keyup|__contextmenu)$/.test(node.attributes[_i100].name)) {
                                attr[node.attributes[_i100].name.substr(2)] = { name: node.attributes[_i100].name.substr(2), camelCase: _LC.String.toCamelCase(node.attributes[_i100].name.substr(2)), helperInfo: actObj, newHelperInfo: Lyte.Compile.getHelper(actValue, true), globalEvent: true };

                                var actArgs = _Lyte.deepCopyObject(actObj.args);
                                var actName = actArgs.splice(0, 1)[0];
                                actName = actName.startsWith("'") ? actName.replace(/'/g, '') : actName;
                                var actString = getArgString(actName, actArgs);
                                node.setAttribute(node.attributes[_i100].name.substr(2), componentName + " => " + actString);
                                if (dynNewCompile) {
                                    dynNewCompile.setAttribute(node.attributes[_i100].name.substr(2), componentName + " => " + actString);
                                }
                                toBeRemoved.push(node.attributes[_i100].name);
                            } else {
                                if (actObj || actValue) {
                                    var _attrToPush = {};

                                    if (node.attributes[_i100].name.startsWith("lbind:")) {
                                        toBeRemoved.push(node.attributes[_i100].name);
                                        toBeAdded.push({ "name": node.attributes[_i100].name.substring(6), "value": node.attributes[_i100].nodeValue });
                                        _attrToPush.isLbind = true;
                                        _attrToPush.name = node.attributes[_i100].name.substring(6);
                                        _attrToPush.camelCase = _LC.String.toCamelCase(_attrToPush.name);
                                    } else {
                                        _attrToPush.name = node.attributes[_i100].name;
                                        _attrToPush.camelCase = _LC.String.toCamelCase(_attrToPush.name);
                                    }
                                    if (actObj) {
                        ...
                        if (node.attributes[_i100].name.startsWith("@")) {
                            var rt = _LC.directive.compileNode(node, attr, toBeRemoved, toBeAdded, _i100, componentName);
                            add = rt.add;
                            attrToPush = rt.attrToPush;
                        }
                    }
                    if (toBeRemoved.length) {
                        for (var _i101 = 0; _i101 < toBeRemoved.length; _i101++) {
                            node.removeAttribute(toBeRemoved[_i101]);
                            if (dynNewCompile) {
                                dynNewCompile.removeAttribute(toBeRemoved[_i101]);
                            }
                        }
                    }
                    if (dynNewCompile) {
                        for (var _key43 in attr) {
                            dynNewCompile.removeAttribute(_key43);
                        }
                        dynNewCompile.setAttribute("_lyteAttr", "__**--Lyte" + j + "__**", "");
                    }
                    if (toBeAdded.length) {
                        for (var _i102 = 0; _i102 < toBeAdded.length; _i102++) {
                            node.setAttribute(toBeAdded[_i102].name, toBeAdded[_i102].value);
                        }
                    }
                }
                break;
            ...
            case "component":
                {
                    ...
                    if ((window.isLyteWidget || window.__lyteEnablePromise) && dynN.hasAttribute("has-child")) {
                        ...
                        for (var _key44 in info.cases) {
                            ...
                            var content = _LC.getContentForIE(actualTemplate.querySelector("[case='" + _LC.cssEscape(_key44) + "']"), undefined, true);
                            setHT(content, info.cases[_key44], contentNewCompile, constr);
                            var gen = doCompile(content.tagName === "TEMPLATE" ? content.content : content, info.cases[_key44].dynamicNodes, componentName, constr, contentNewCompile);
                            var gnxt = gen.next(),
                                gval;
                            while (gnxt.done == false) {
                                gval = gnxt.value;
            ...
            case "switch":
                {
                    ...
                    if (_Lyte._ms) {
                        ...
                        for (var _key45 in info.cases) {
                            var _contentNewCompile = void 0;
                            content = _LC.getContentForIE(cases[_key45], undefined, true);
                            if (actualTemplateNewCompile) {
                                _contentNewCompile = _LC.getContentForIE(actualTemplateNewCompile.querySelector("[case='" + LyteComponent.cssEscape(_key45) + "']"));
                            }
                            setHT(content, info.cases[_key45], _contentNewCompile, constr);
                            var gen = doCompile(content, info.cases[_key45].dynamicNodes, componentName, constr, _contentNewCompile ? _LC.getContentForIE(_contentNewCompile) : undefined);
                            var gnxt = gen.next(),
                                gval;
                            while (gnxt.done == false) {
                                gval = gnxt.value;
                            ...
                            cases[_key45].remove();
                            if (actualTemplateNewCompile) {
                                info.cases[_key45]._sta = _LC.processStatic(_contentNewCompile);
                            }
                            info.cases[_key45].templateContent = cases[_key45].outerHTML;
                        }
                        ...
                        for (var _key46 in info.cases) {
                            ...
                            if (actualTemplateNewCompile) {
                                _contentNewCompile3 = _LC.getContentForIE(actualTemplateNewCompile.querySelector("[case='" + LyteComponent.cssEscape(_key46) + "']"));
                            }
                            var content = _LC.getContentForIE(dynNContent.querySelector("[case='" + _LC.cssEscape(_key46) + "']"), undefined, true);
                            setHT(content, info.cases[_key46], _contentNewCompile3, constr);
                            var gen = doCompile(content.tagName === "TEMPLATE" ? content.content : content, info.cases[_key46].dynamicNodes, componentName, constr, _contentNewCompile3);
                            var gnxt = gen.next(),
                                gval;
                            while (gnxt.done == false) {
                                gval = gnxt.value;
                            ...
                            if (actualTemplateNewCompile) {
                                info.cases[_key46]._sta = _LC.processStatic(_contentNewCompile3);
                            }
    ...
    function getArgString(name, array) {
        ...
        for (var _i103 = 0; _i103 < array.length; _i103++) {
            if (array[_i103] && _typeof(array[_i103]) === "object") {
                array[_i103] = getArgString(array[_i103].value.name, array[_i103].value.args);
            }
        }
        if (name) {
    ...
    defProp(HTMLElement.prototype, 'setData', {
        ...
        value: function value(arg0, arg1) {
            ...
            if (typeof arg0 === "string") {
                ...
                for (var _key47 in arg0) {
                    if (window.isLyteWidget && this.tagName != "TEMPLATE") {
                        DataBindingLayer.updateInitProperties(this, _key47, arg0[_key47]);
                    }
                    this._initProperties[_key47] = arg0[_key47];
                }
            }
        }
    });
    ...
    defProp(HTMLElement.prototype, 'setMethods', {
        ...
        value: function value(arg0, arg1) {
            ...
            if (typeof arg0 === "string") {
                ...
                for (var _key48 in arg0) {
                    this._initMethods[_key48] = arg0[_key48];
                }
            }
        }
    });
    ...
    Lyte.Compile.getTrimmedContent = function (content, position, node) {
        ...
        for (var _i104 = 0; _i104 < position.length; _i104++) {
            for (var _j13 = content.childNodes.length - 1; _j13 > position[_i104]; _j13--) {
                content.childNodes[_j13].remove();
            }
            content = content.childNodes[position[_i104]];
        }
        return dummyContent;
    };
    Lyte.Compile.getArrayIndex = function (array, value) {
        for (var _i105 = 0; _i105 < array.length; _i105++) {
            if (array[_i105] === value) {
                return _i105;
            };
        }
    };
    ...
    Lyte.Compile.getHelperArgs = function (str, newCompile) {
        ...
        for (var _i106 = 0; _i106 < str.length; _i106++) {
            if (!stack.length && str.charAt(_i106) === ",") {
                var _toPush2 = str.substr(from, _i106 - from);
                ...
                args.push(_toPush2);
                from = _i106 + 1;
            } else if (str.charAt(_i106) === "(") {
                if (stack[stack.length - 1] != "'" && stack[stack.length - 1] != "\"") {
                    stack.push(str.charAt(_i106));
                    lastPushed = str.charAt(_i106);
                }
            } else if (str.charAt(_i106) === ")") {
                if (stack[stack.length - 1] === "(") {
                    stack.pop();
                }
            } else if (str.charAt(_i106) === "'" && str.charAt(_i106 - 1) !== "\\") {
                if (stack[stack.length - 1] === "'") {
                    stack.pop();
                    ...
                    setTimeout(function () {
                        ...
                        for (var i = arr.length - 1; i >= 0; i--) {
                            ...
                            if (_LC.isViewPortTemplate(_temp2) && !_temp2._callee._destroyed) {
                                var _obj10 = {};
                                if (_LC._isInViewPort(actTemp, actTemp._callee, beforeRemoveHook, undefined, _obj10)) {
                                    var nd = pve.splice(i, 1)[0];
                                    _temp2._inPve = false;
                                    _temp2._viewPortRendered = true;
                                    !_obj10.beforeRemoveHook && inViewTemplates.push(nd);
                                }
                                actTemp._inPve = _temp2._inPve;
                                actTemp._viewPortRendered = _temp2._viewPortRendered;
                            }
                        }
                        for (var _i107 = 0; _i107 < beforeRemoveHook.length; _i107++) {
                            beforeRemoveHook[_i107].viewOutIns.beforeRemove.apply(beforeRemoveHook[_i107].viewOutIns, beforeRemoveHook[_i107].arg);
                            _LC.waitingForResolve.push(beforeRemoveHook[_i107].node._renderPromise);
                        }
                        for (var _i108 = 0; _i108 < inViewTemplates.length; _i108++) {
                            _LC._executeIfTemplates(inViewTemplates[_i108]);
                        }
        ...
        if (LyteComponent.pendingViewPortElements) {
            requestAnimationFrame(function () {
                setTimeout(function () {
                    ...
                    for (var _key49 in _LC._doneRaf) {
                        if (_LC._doneRaf[_key49]) {
    ...
    LyteComponent.executePendingViewPort = function (options) {
        ...
        if ((!options || !options.force) && !_LC.autoRender) {
            ...
            for (var _i109 = 0; _i109 < beforeRemoveHook.length; _i109++) {
                beforeRemoveHook[_i109].viewOutIns.beforeRemove.apply(beforeRemoveHook[_i109].viewOutIns, beforeRemoveHook[_i109].arg);
            }
        } else {
